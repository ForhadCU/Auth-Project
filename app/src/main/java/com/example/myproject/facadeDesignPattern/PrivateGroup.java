...
public class PrivateGroup implements IDbHandler {
    ...
    private static PrivateGroup PrivateGroupInstance=null;
    ...
    public static PrivateGroup getCompanyInstance() {
        if(PrivateGroupInstance==null) {
            PrivateGroup c1=new PrivateGroup();
            PrivateGroupInstance=c1;
        }
        return PrivateGroupInstance;
    }
